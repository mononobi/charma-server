...
class MoviesManager(Manager, MoviesQueries, HookMixin):
    ...
    def create(self, library_title, directory_name, **options):
        ...
        entity.search_library_title = self._get_normalized(entity.library_title)
        entity.identifier = self._get_normalized(entity.imdb_page)
        entity.search_title = self._get_normalized(entity.title)
        entity.search_original_title = self._get_normalized(entity.original_title)
        entity.search_storyline = self._get_normalized(entity.storyline)
        entity.save()
