...
from charma.movies.queries import MoviesQueries
from charma.movies.exceptions import MovieDoesNotExistError, InvalidMovieHookTypeError
...
class MoviesManager(Manager, MoviesQueries, HookMixin):
    ...
    def _get(self, id):
        ...
        :rtype: charma.movies.models.MovieEntity
        """
